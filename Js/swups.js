  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.cleanupAnimationClasses =
          exports.Link =
          exports.markSwupElements =
          exports.normalizeUrl =
          exports.getCurrentUrl =
          exports.transitionProperty =
          exports.transitionEnd =
          exports.fetch =
          exports.getDataFromHtml =
          exports.createHistoryRecord =
          exports.classify =
            undefined;
        ...
        var _createHistoryRecord2 =
          _interopRequireDefault(_createHistoryRecord);
        ...
        var _cleanupAnimationClasses2 = _interopRequireDefault(
        ...
        var createHistoryRecord = (exports.createHistoryRecord =
          _createHistoryRecord2.default);
        var getDataFromHtml = (exports.getDataFromHtml =
          _getDataFromHtml2.default);
        var fetch = (exports.fetch = _fetch2.default);
        var transitionEnd = (exports.transitionEnd = _transitionEnd2.default);
        var transitionProperty = (exports.transitionProperty =
          _transitionProperty2.default);
        var getCurrentUrl = (exports.getCurrentUrl = _getCurrentUrl2.default);
        var normalizeUrl = (exports.normalizeUrl = _normalizeUrl2.default);
        var markSwupElements = (exports.markSwupElements =
          _markSwupElements2.default);
        var Link = (exports.Link = _Link2.default);
        var cleanupAnimationClasses = (exports.cleanupAnimationClasses =
          _cleanupAnimationClasses2.default);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var escapeCssIdentifier = (exports.escapeCssIdentifier =
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Link = (function () {
          function Link(elementOrUrl) {
            ...
            if (
              elementOrUrl instanceof Element ||
              elementOrUrl instanceof SVGElement
            ) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var _getAnimationPromises2 = _interopRequireDefault(
          _getAnimationPromises
        );
          ...
          _createClass(Swup, [
            {
              ...
              value: function enable() {
                ...
                // add event listeners
                this.delegatedListeners.click = (0, _delegateIt2.default)(
                  document,
                  ...
                  if (event.button === 0) {
                    ...
                    if (
                      ...
                      if (link.getHash() != "") {
                        ...
                        var element = (0, _getAnchorElement2.default)(
                          link.getHash()
                        );
                        if (element != null) {
                      ...
                      var customTransition = event.delegateTarget.getAttribute(
            ...
            },
            {
              ...
              value: function popStateHandler(event) {
                ...
                var link = new _helpers.Link(
                  event.state ? event.state.url : window.location.pathname
                );
                if (link.getHash() !== "") {
                  this.scrollToElement = link.getHash();
                } else {
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        function editLedger(wanted, baseElement, callback, setup) {
          ...
          const elementMap =
            (_a = ledger.get(baseElement)) !== null && _a !== void 0
              ? _a
              : new WeakMap();
          ...
          const setups =
            (_b = elementMap.get(callback)) !== null && _b !== void 0
              ? _b
              : new Set();
        ...
        function delegate(base, selector, type, callback, options) {
          ...
          const baseElement =
            base instanceof Document ? base.documentElement : base;
          ...
          const isAlreadyListening = editLedger(
            true,
            baseElement,
            callback,
            setup
        ...
        var getDataFromHtml = function getDataFromHtml(html, containers) {
          ...
          containers.forEach(function (selector) {
            if ((0, _utils.query)(selector, fakeDom) == null) {
              console.warn(
                "[swup] Container " + selector + " not found on page."
              );
              return null;
            } else {
              if (
                (0, _utils.queryAll)(selector).length !==
                (0, _utils.queryAll)(selector, fakeDom).length
              ) {
                console.warn(
              ...
              (0, _utils.queryAll)(selector).forEach(function (item, index) {
                (0, _utils.queryAll)(selector, fakeDom)[index].setAttribute(
                  "data-swup",
                  blocks.length
                );
                blocks.push(
                  (0, _utils.queryAll)(selector, fakeDom)[index].outerHTML
                );
              });
            }
          });
        ...
        var markSwupElements = function markSwupElements(element, containers) {
          ...
          containers.forEach(function (selector) {
            if ((0, _utils.query)(selector, element) == null) {
              ...
              (0, _utils.queryAll)(selector).forEach(function (item, index) {
                (0, _utils.queryAll)(selector, element)[index].setAttribute(
                  "data-swup",
                  blocks
                );
                blocks++;
        ...
        var loadPage = function loadPage(data, popstate) {
          ...
          var animateOut = function animateOut() {
            ...
            document.documentElement.classList.add(
              "to-" + (0, _helpers.classify)(data.url)
            );
          ...
          if (data.customTransition != null) {
            ...
            document.documentElement.classList.add(
              "to-" + (0, _helpers.classify)(data.customTransition)
            );
          } else {
          ...
          if (this.cache.exists(data.url)) {
            ...
            if (!this.preloadPromise || this.preloadPromise.route != data.url) {
              xhrPromise = new Promise(function (resolve, reject) {
                (0,
                _helpers.fetch)(_extends({}, data, { headers: _this.options.requestHeaders }), function (response) {
          ...
          if (event != null) {
            if (handler != null) {
              if (
                ...
                var toRemove = this._handlers[event].filter(function (
                  savedHandler
                ) {
                  return savedHandler === handler;
                })[0];
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var getAnimationPromises = function getAnimationPromises() {
          ...
          var durationProperty =
            (0, _helpers.transitionProperty)() + "Duration";
          var promises = [];
          var animatedElements = (0, _utils.queryAll)(selector, document.body);

          if (!animatedElements.length) {
            console.warn(
              "[swup] No animated elements found by selector " + selector
            );
          ...
          animatedElements.forEach(function (element) {
            var transitionDuration =
              window.getComputedStyle(element)[durationProperty];
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var getPageData = function getPageData(request) {
          ...
          var pageObject = (0, _helpers.getDataFromHtml)(
            html,
            this.options.containers
          );

          if (pageObject) {
            pageObject.responseURL = request.responseURL
              ? request.responseURL
              : window.location.href;
          } else {
